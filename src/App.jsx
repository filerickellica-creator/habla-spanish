...
function VerifyEmailScreen({ oobCode }) {
  ...
  return (
    <div style={s.root}>
      <div style={s.card}>
        ...
        {busy ? (
          <div style={{ textAlign: "center", color: "#6b6560", fontFamily: "sans-serif", padding: "20px 0" }}>
          ...
          <div style={s.ok}>
            ...
            <div style={{ fontSize: 13, color: "#6b6560", marginBottom: 16 }}>Your email has been verified. You can now sign in.</div>
            <button style={s.btn} onClick={() => window.location.href = "/"}>Go to Sign In</button>
          </div>
        ) : (
          <div>
...
export default function App() {
  ...
  if (mode === "verifyEmail" && oobCode) {
    return <VerifyEmailScreen oobCode={oobCode} />;
  }
